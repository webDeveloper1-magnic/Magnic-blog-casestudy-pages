export default function DemoCta({
  ...
  return (
    <section className="container-page">
      <div className="grid items-center gap-8 rounded-card border border-line border-l-[4px] border-l-accent bg-surface px-7 py-10 shadow-card md:grid-cols-[1fr_auto] md:px-12">
        <div>
